...
import { MainScreenIcon } from "../components/MainScreenIcon";
...
const ChatComponent = () => {
  const [chatHistory, setChatHistory] = React.useState<IChat[]>([]);
            ...
            <div className="bubbles-wrapper">
              <SampleInputBubble
                onClick={() => {
                  setChatHistory([
                    ...chatHistory,
                    { role: "user", content: bubbleOneText },
                  ]);
                  handleSendMessage([
                    ...chatHistory,
                    { role: "user", content: bubbleOneText },
              ...
              <SampleInputBubble
                onClick={() => {
                  setChatHistory([
                    ...chatHistory,
                    { role: "user", content: bubbleTwoText },
                  ]);
                  handleSendMessage([
                    ...chatHistory,
                    { role: "user", content: bubbleTwoText },
